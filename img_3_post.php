...
<section>
  <div class="container">
    ...
    if(isset($_GET["id"])){
$id=$_GET["id"];
$sel="SELECT * FROM english_3_img where id='$id'";
  $select=mysqli_query($con,$sel);
  $three=mysqli_fetch_array($select);
$p_desc1=$three["p_desc1"];
$p_desc2=$three["p_desc2"];
$p_desc3=$three["p_desc3"];
$id=$three["id"];
...
$p_img3=$three["p_img3"];
   ...
   ?>
      <div class="col-lg-8 col-sm-10 col-md-10 mx-auto">
        ...
        <div class="my-3">
        <img src="img_3/<?php echo $p_img1; ?>" alt="thumbnail" class="img-thumbnail"
  style="width:100%;">
</div>
...
<div>
  ...
  <div class="card-header text-center">
    ...
    <div class="card-body text-center">
     ...
     $sel="SELECT * FROM english_3_img order by id desc limit 0,3 ";
     $select=mysqli_query($con,$sel);
...
<?php } ?>
 ...
 <div class="my-3">
        <img src="img_3/<?php echo $p_img2; ?>" alt="thumbnail" class="img-thumbnail"
...
<div class="my-3">
        <img src="img_3/<?php echo $p_img3; ?>" alt="thumbnail" class="img-thumbnail"
  style="width:100%;height: 500px;">
...
<section class="my-5">
 ...
 <?php
 $sel="SELECT * FROM english_3_img where p_category='DEFENCE' order by rand()  limit 0,5";
